...
# Usage:
#
# Rscript combinedInitialCultureComponentsFinalMultilineErrorBars.R 
#
#
# Output .eps file is
#
#  combined-initcultureconnectedcomponents-multilineerrorbars.eps
#
...
results_filenames <- c('../../axelrod_new_newinit_internal2_results/equilibrium_initneutralevolution_results.csv',
                       '../../axelrod_new_newinit_internalprototype_results/equilibrium_initneutralevolution_results.csv',
                       '../../axelrod_internaltrivialultrametric_results/equilibrium_initneutralevolution_results.csv')
...
postscript('combined-initcultureconnectedcomponents-multilineerrorbars.eps',
