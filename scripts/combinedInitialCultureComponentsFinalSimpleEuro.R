...
# Usage:
#
# Rscript combinedIntialCultureComponentsFinalSimpleEuro.R
#
# Output .eps file is
#
#  combined-simple-euro-gss-initcultureconnectedcomponents-num_cultures.eps
#
# This version is for the results from the simple Axelrod model (not the
# one with migration and social networks).
...
results_filenames <- c('../../axelrod_simple_merged_eurobarometer_reults/50samples/multiendresults.csv',
                       '../../axelrod_simple_merged_gss_results/600samples/multiendresults.csv',
                       '../../axelrod_simple_merged_simulated_eurobarometer_reults/50samples/multiendresults.csv',
                       '../../axelrod_simple_merged_simulated_gss_results/600samples/multiendresults.csv')
...
#    p <- p + facet_grid(m ~ beta_s , labeller =  bla)
    ...
    p <- p + opts(plot.margin = 	    unit(c(0,0,0,0), "lines"),
     ...
     p <- p + theme(legend.position=c(0.5,0.5), legend.justification=c(1,0))
...
postscript('combined-simple-euro-gss-initcultureconnectedcomponents-num_cultures.eps',
