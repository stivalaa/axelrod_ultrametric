...
responses=c("Number of communities", "Intra-community diversity", "Inter-community diversity", "Number of cultures", "Assortativitiy", "Clustering coefficient", "Modularity", "Mean degree")
...
D <- summaryBy(value ~ n + beta_s + theta + time + variable, data=D, FUN=c(mean,sd)) 
