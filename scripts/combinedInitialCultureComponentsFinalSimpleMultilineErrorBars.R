...
# Usage:
#
# Rscript combinedInitialCultureComponentsFinalSimpleMultilineErrorBars.R 
#
#
# Output .eps file is
#
#  combined-simple-initcultureconnectedcomponents-multilineerrorbars.eps
#
# This version created to make single EPS file using grid.arrange with
# three different initial culture schemes but fixed single value of q
# and F to fit in page-limited 2 column journal format
#
# ADS August 2013
...
results_filenames <- c('../../axelrod_simple_internal2_results/equilibrium_initneutralevolution_results.csv',
                       '../../axelrod_simple_internalprototype_results/equilibrium_initneutralevolution_results.csv',
                       '../../axelrod_simple_internaltrivialultrametric_results/equilibrium_initneutralevolution_results.csv')
results_names <- c('neutral evolution', 'prototype evolution', 'trivial ultrametric')
...
postscript('combined-simple-initcultureconnectedcomponents-multilineerrorbars.eps',
