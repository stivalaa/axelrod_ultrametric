...
# type of graph e.g.  theta-initrandomprob-qF-num_communities.eps etc.
# (fixed values of N/L^2,beta_s, facets on q and F)
#                    
#
# ADS February 2013
...
for (r in 1:length(responses)) {
  ...
  postscript(paste("img/theta-initrandomprob-qF-", stats[r+8], ".eps", sep=''), 
