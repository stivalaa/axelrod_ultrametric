...
# the permuted data has only the columns we want already

#euro_tech <- read.csv('~/culture_evolution/data/EuroBarometer/Eurobarometer1992analysis_500samples_permuted.csv',header=FALSE)
euro_tech <- read.csv('~/culture_evolution/data/EuroBarometer/Eurobarometer1992analysis_50samples_permuted.csv',header=FALSE)


F <- length(euro_tech)
n <- length(euro_tech$V1)
